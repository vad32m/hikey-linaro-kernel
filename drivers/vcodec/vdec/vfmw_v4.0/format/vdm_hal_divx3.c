/*
 *      Video Decode driver for hikey960   divx3 master 
...
void DIVX3HAL_WriteReg(OMXVDH_REG_CFG_S *pVdhRegCfg)
{
	...
	D32 = 0;
	((DIVX3_BASIC_CFG0 *)(&D32))->mbamt_to_dec         = ((DIVX3_BASIC_CFG0 *)(&pVdhRegCfg->VdhBasicCfg0))->mbamt_to_dec;
	((DIVX3_BASIC_CFG0 *)(&D32))->ld_qmatrix_flag      = 0;
	((DIVX3_BASIC_CFG0 *)(&D32))->marker_bit_detect_en = 0;
	((DIVX3_BASIC_CFG0 *)(&D32))->ac_last_detect_en    = 0;
	((DIVX3_BASIC_CFG0 *)(&D32))->coef_idx_detect_en   = 0;
	((DIVX3_BASIC_CFG0 *)(&D32))->vop_type_detect_en   = 0;
	((DIVX3_BASIC_CFG0 *)(&D32))->sec_mode_en          = 0;
	...
	D32 = 0;
	((DIVX3_BASIC_CFG1 *)(&D32))->video_standard       = 0x5;
	((DIVX3_BASIC_CFG1 *)(&D32))->ddr_stride           = ((DIVX3_BASIC_CFG1 *)(&pVdhRegCfg->VdhBasicCfg1))->ddr_stride;
	((DIVX3_BASIC_CFG1 *)(&D32))->fst_slc_grp          = 1;
	((DIVX3_BASIC_CFG1 *)(&D32))->mv_output_en         = 1;
	((DIVX3_BASIC_CFG1 *)(&D32))->uv_order_en          = ((DIVX3_BASIC_CFG1 *)(&pVdhRegCfg->VdhBasicCfg1))->uv_order_en;
	((DIVX3_BASIC_CFG1 *)(&D32))->vdh_2d_en            = 1;
	((DIVX3_BASIC_CFG1 *)(&D32))->max_slcgrp_num       = 0;
	((DIVX3_BASIC_CFG1 *)(&D32))->line_num_output_en   = 0;
	((DIVX3_BASIC_CFG1 *)(&D32))->compress_en          = ((DIVX3_BASIC_CFG1 *)(&pVdhRegCfg->VdhBasicCfg1))->compress_en;
	((DIVX3_BASIC_CFG1 *)(&D32))->ppfd_en              = 0;

	write_register_value(0  ,  VREG_BASIC_CFG1, D32);

	//AVM_ADDR
	D32 = 0;
	((DIVX3_AVM_ADDR *)(&D32))->av_msg_addr = (pVdhRegCfg->VdhAvmAddr) & 0xFFFFFFF0;
	write_register_value(0  , VREG_AVM_ADDR, D32);

	//VAM_ADDR
	D32 = 0;
	((DIVX3_VAM_ADDR *)(&D32))->va_msg_addr = (pVdhRegCfg->VdhVamAddr) & 0xFFFFFFF0;
	...
	//FF_APT_EN
	D32 = 0;
	((DIVX3_FF_APT_EN *)(&D32))->ff_apt_en = 0;  //Always use FrameSave Mode, USE_FF_APT_EN
